 ...
 * dibujan, solo dicen qué hace. Así el ＋ de cotizaciones, notas de venta y
 * facturación sale gratis: cada vista registra su acción y hereda el mismo
...
export function useAccionCrear(etiqueta, ejecutar) {
    ...
    onUnmounted(() => {
        ...
        // borrara a ciegas, la pantalla entrante se quedaría sin su ＋.
