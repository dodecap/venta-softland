...
# Fondo de la pantalla de arranque y cuánto del lado corto ocupa el logo. Un
# tercio: más grande parece un error de escala y más chico no se ve en un
# teléfono al sol.
FONDO_ARRANQUE = (255, 255, 255)
LOGO_ARRANQUE = 1 / 3
...
def arranque(logo: Image.Image) -> int:
    ...
    for archivo in sorted(RES.glob('drawable*/splash.png')):
        ...
        lienzo = Image.new('RGB', (ancho, alto), FONDO_ARRANQUE)
...
def main() -> None:
    ...
    print('El fondo del icono adaptable es @color/ic_launcher_background '
