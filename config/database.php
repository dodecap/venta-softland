...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Conexión a la base Softland (SQL Server). Los valores se resuelven en
        // tiempo de ejecución: SoftlandConnection::apply() sobrescribe estos
        // con la configuración cifrada guardada por /setup. El env es fallback.
        'softland' => [
            'driver' => 'sqlsrv',
